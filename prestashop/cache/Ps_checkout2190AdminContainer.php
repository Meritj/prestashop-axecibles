 ...
 */
class Ps_checkout2190AdminContainer extends Container
{
    private $parameters = [];
    private $targetDirs = [];
    ...
    {
        return $this->services['ps_checkout.cache.directory'] = new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('1.6.1.24', '/Applications/MAMP/htdocs/testremi/prestashop/prestashop', false);
    }
    ...
    {
        return $this->services['ps_checkout.cache.paypal.merchant_integration'] = new \Symfony\Component\Cache\Simple\FilesystemCache('merchant-integration', 86400, ${($_ = isset($this->services['ps_checkout.cache.directory']) ? $this->services['ps_checkout.cache.directory'] : ($this->services['ps_checkout.cache.directory'] = new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('1.6.1.24', '/Applications/MAMP/htdocs/testremi/prestashop/prestashop', false))) && false ?: '_'}->getPath());
    }
    ...
    {
        return $this->services['ps_checkout.logger.directory'] = new \PrestaShop\Module\PrestashopCheckout\Logger\LoggerDirectory('1.6.1.24', '/Applications/MAMP/htdocs/testremi/prestashop/prestashop');
    }
